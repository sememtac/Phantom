...
#define FT_STEP_US 500u
    ...
    if (win && Serial.availableForWrite() > 2048) {
        ...
        Serial.printf("%.1f fps | in %lu upd %lu sub %lu "
                      ...
                      "| aa %lu ln %lu(%lupx %lun) tri %lu pt %lu gl %lu fl %lu oth %lu can %lu bez %lu tnt %lu mir %lu "
